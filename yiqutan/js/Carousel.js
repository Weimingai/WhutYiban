...
; (function($) {
    var Carousel = function(poster) {
		...
		/*
		var namet1=document.getElementById(this.posterItems.first());
		var namew1=str.substring(2);
		namew1.classList.add("zhebi2");
		*/
        this.posterLastItem = this.posterItems.last(); //最后/上一个幻灯片
		/*
		var namet2=document.getElementById(this.posterItems.first());
		var namew2=str.substring(2);
		namew.classList.remove("zhebi2");
		*/
